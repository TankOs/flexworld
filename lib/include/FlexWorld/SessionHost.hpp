	...
	public lua::WorldGate
{
	public:
		 ...
		 * @throws std::runtime_error in case of any error.
		 */
		uint32_t create_entity( const FlexID& cls_id, const EntityPosition& position, const std::string& planet_id );
		 ...
		 * @throws std::runtime_error in case of any error.
		 */
		uint32_t create_entity( const FlexID& cls_id, uint32_t parent_id, const std::string& hook_id );
